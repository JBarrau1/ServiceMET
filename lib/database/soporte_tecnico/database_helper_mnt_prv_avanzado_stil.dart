...
class DatabaseHelperMntPrvAvanzadoStil {
  ...
  Future<Database> _initDatabase() async {
    ...
    try {
      String path = join(await getDatabasesPath(), 'mnt_prv_avanzado_stil.db');
  ...
  Future<void> _onCreate(Database db, int version) async {
    try {
      debugPrint('Creando tabla mnt_prv_avanzado_stil...');
      ...
      debugPrint('Tabla mnt_prv_avanzado_stil creada exitosamente');
    } catch (e) {
  ...
  Future<int> insertRegistroRelevamiento(Map<String, dynamic> registro) async {
    try {
      final db = await database;
      return await db.insert('mnt_prv_avanzado_stil', registro);
    } catch (e) {
