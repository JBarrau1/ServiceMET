...
class PrecargasAjusteStep extends StatelessWidget {
    ...
    return Column(
      children: [
        const Text(
          ...
          style: TextStyle(
              fontSize: 17, fontWeight: FontWeight.w900, color: Colors.orange),
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return _buildPreloadRow(context, controller, index);
          },
        ),
        const SizedBox(height: 20.0),
        ...
        if (controller.isAjusteRealizado) ...[
          ...
          if (controller.isAjusteExterno) ...[
            ...
            TextFormField(
              ...
              decoration:
                  _buildInputDecoration('Cargas de Pesas Patrón Utilizadas'),
  ...
  Widget _buildPreloadRow(
      BuildContext context, InicioServicioController controller, int index) {
    return Padding(
                    ...
                    suffixIcon: PopupMenuButton<String>(
                      ...
                      itemBuilder: (BuildContext context) {
                        final baseValue = double.tryParse(controller
                                .indicacionesControllers[index].text) ??
                            0.0;
                        return _buildPopupMenuItems(
                            baseValue, d1, decimalPlaces);
                      },
                    ),
                  ),
                  keyboardType:
  ...
  List<PopupMenuItem<String>> _buildPopupMenuItems(
      double baseValue, double d1, int decimalPlaces) {
