// ignore_for_file: unused_field, library_private_types_in_public_api, use_build_context_synchronously, deprecated_member_use
...
class _FinServicioDiagnosticoScreenState
  ...
  Future<void> _confirmarYExportar(BuildContext context) async {
    try {
      ...
      final rows = await db.query(
        ...
        whereArgs: [widget.secaValue, 'Completo', 'Diagnóstico'],
      );
  ...
  Future<void> _exportToCSV(
    ...
    try {
      ...
      final fileName =
          '${widget.secaValue}_${DateFormat('yyyy-MM-dd_HH-mm-ss').format(DateTime.now())}diagnostico.csv';
  ...
  Future<void> _confirmarSeleccionOtraBalanza(BuildContext context) async {
    ...
    try {
      ...
      final List<Map<String, dynamic>> rows = await db.query(
        ...
        whereArgs: [widget.secaValue, 'Diagnóstico'],
