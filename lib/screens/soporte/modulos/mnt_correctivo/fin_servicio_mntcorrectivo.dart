...
import 'package:service_met/database/soporte_tecnico/database_helper_mnt_correctivo.dart';
...
class _FinServicioMntcorrectivoScreenState
  ...
  Future<void> _exportToCSV(
    ...
    try {
      ...
      final fileName =
          '${widget.secaValue}_${DateFormat('yyyy-MM-dd_HH-mm-ss').format(DateTime.now())}mnt_correctivo.csv';
