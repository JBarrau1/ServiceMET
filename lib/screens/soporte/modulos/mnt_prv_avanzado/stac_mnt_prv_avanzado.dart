...
import 'package:service_met/screens/soporte/modulos/mnt_prv_avanzado/fin_servicio_stac.dart';
...
class StacMntPrvAvanzadoStacScreen extends StatefulWidget {
  ...
  @override
  State<StacMntPrvAvanzadoStacScreen> createState() =>
...
// Nueva seccion
  final TextEditingController _elevadoPuenteComentarioController =
      TextEditingController();
  final TextEditingController _limpiezaEstructuraComentarioController =
      TextEditingController();
  final TextEditingController _bearingCupsComentarioController =
      TextEditingController();
  final TextEditingController _celdasCargaComentarioController =
      TextEditingController();
  final TextEditingController _lubricacionCabezasComentarioController =
      TextEditingController();
  final TextEditingController _engrasadoBearingComentarioController =
      TextEditingController();
  final TextEditingController _lainasBotasComentarioController =
      TextEditingController();
...
// Sección de Calibración
  ...
  void initState() {
    ...
    _elevadoPuenteComentarioController.text = "Sin comentario";
    _limpiezaEstructuraComentarioController.text = "Sin comentario";
    _bearingCupsComentarioController.text = "Sin comentario";
    _celdasCargaComentarioController.text = "Sin comentario";
    _lubricacionCabezasComentarioController.text = "Sin comentario";
    _engrasadoBearingComentarioController.text = "Sin comentario";
    _lainasBotasComentarioController.text = "Sin comentario";
  ...
  void _showSnackBar(BuildContext context, String message,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor:
            backgroundColor ?? Colors.green, // Fondo naranja por defecto
      ),
    );
  }
          ...
          child: Column(
            children: [
              ...
              _buildDropdownFieldWithComment(
                  context,
                  'Elevado del puente de pesaje y retirado de las celdas de carga',
                  _elevadoPuenteComentarioController),
              const SizedBox(height: 20.0),
              _buildDropdownFieldWithComment(
                  context,
                  'Limpieza e inspección de superficies de acoplamiento de la estructura',
                  _limpiezaEstructuraComentarioController),
              const SizedBox(height: 20.0),
              _buildDropdownFieldWithComment(
                  context,
                  'Limpieza e inspección de bearing cups',
                  _bearingCupsComentarioController),
              const SizedBox(height: 20.0),
              _buildDropdownFieldWithComment(
                  context,
                  'Limpieza e inspección de celdas de carga',
                  _celdasCargaComentarioController),
              const SizedBox(height: 20.0),
              _buildDropdownFieldWithComment(
                  context,
                  'Lubricación de cabezas de celdas de carga',
                  _lubricacionCabezasComentarioController),
              const SizedBox(height: 20.0),
              _buildDropdownFieldWithComment(
                  context,
                  'Engrasado de bearing cups',
                  _engrasadoBearingComentarioController),
              const SizedBox(height: 20.0),
              _buildDropdownFieldWithComment(
                  context,
                  'Lainas, botas de goma colocadas',
                  _lainasBotasComentarioController),
              const SizedBox(height: 20.0),
              Align(
                alignment: Alignment.centerLeft,
                child: Text(
