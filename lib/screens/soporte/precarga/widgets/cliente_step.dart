...
class _ClienteStepState extends State<ClienteStep> {
  ...
  Widget _buildTermohigrometroSelection(PrecargaControllerSop controller) {
    return Container(
  ...
  Widget _buildSelectedTermohigrometrosInfo(PrecargaControllerSop controller) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
  ...
  void _showTermohigrometrosSelection(PrecargaControllerSop controller) {
