...
class _PlantaStepState extends State<PlantaStep> {
  ...
  Widget _buildClienteInfo(PrecargaControllerSop controller) {
    return Container(
  ...
  Widget _buildNewPlantaSection(PrecargaControllerSop controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildExistingPlantaSection(PrecargaControllerSop controller) {
  ...
  Widget _buildSelectedPlantaInfo(PrecargaControllerSop controller) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
  ...
  void _showAddPlantaDialog(BuildContext context, PrecargaControllerSop controller) {
