...
class _EquiposStepState extends State<EquiposStep> {
  ...
  Widget _buildEquiposSelectionButtons(PrecargaControllerSop controller) {
    return Column(
      children: [
        // Pesas Patrón
        SizedBox(
  ...
  Widget _buildSelectedEquiposList(PrecargaControllerSop controller) {
  ...
  Widget _buildEquipoCard(Map<String, dynamic> equipo, int index, PrecargaControllerSop controller) {
  ...
  Widget _buildEquiposResumen(PrecargaControllerSop controller) {
  ...
  void _showPesasPatronSelection(PrecargaControllerSop controller) {
